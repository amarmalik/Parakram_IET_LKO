 ...
 */
public class ShinnyTextView3 extends TextView {
    ...
    public ShinnyTextView3(final Context context) {
        this(context, null);
    }

    public ShinnyTextView3(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("NewApi")
	public ShinnyTextView3(final Context context, final AttributeSet attrs, final int defStyleAttr) {
    ...
    protected void onSizeChanged(final int w, final int h, final int oldw, final int oldh) {
        ...
        if (!isInEditMode()) {
            ...
            mAnimator.setDuration(20 * w); // custom
    ...
    private Shader generateGradientShader(int width, float... positions) {
        int[] colorRepartition = {Color.GREEN, Color.WHITE, Color.BLUE};
