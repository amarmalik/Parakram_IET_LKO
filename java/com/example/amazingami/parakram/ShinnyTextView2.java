 ...
 */
public class ShinnyTextView2 extends TextView {
    ...
    public ShinnyTextView2(final Context context) {
        this(context, null);
    }

    public ShinnyTextView2(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("NewApi")
	public ShinnyTextView2(final Context context, final AttributeSet attrs, final int defStyleAttr) {
